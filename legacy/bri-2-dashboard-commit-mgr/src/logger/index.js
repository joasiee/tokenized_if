...
const reqLogger = (service) => express_winston_1.default.logger({
    transports: [
...
const reqErrorLogger = (service) => express_winston_1.default.errorLogger({
    transports: [
...
exports.reqErrorLogger = reqErrorLogger;
