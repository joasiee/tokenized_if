...
interface IZKPService_IGetCircuit extends grpc.MethodDefinition<zkp_pb.GetCircuitRequest, zkp_pb.Circuit> {
    path: "/zkp.ZKP/GetCircuit";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<zkp_pb.GetCircuitRequest>;
    requestDeserialize: grpc.deserialize<zkp_pb.GetCircuitRequest>;
...
export interface IZKPServer extends grpc.UntypedServiceImplementation {
    getCircuit: grpc.handleUnaryCall<zkp_pb.GetCircuitRequest, zkp_pb.Circuit>;
    addCircuit: grpc.handleUnaryCall<zkp_pb.Circuit, google_protobuf_empty_pb.Empty>;
}

export interface IZKPClient {
    getCircuit(request: zkp_pb.GetCircuitRequest, callback: (error: grpc.ServiceError | null, response: zkp_pb.Circuit) => void): grpc.ClientUnaryCall;
    getCircuit(request: zkp_pb.GetCircuitRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: zkp_pb.Circuit) => void): grpc.ClientUnaryCall;
    getCircuit(request: zkp_pb.GetCircuitRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: zkp_pb.Circuit) => void): grpc.ClientUnaryCall;
...
export class ZKPClient extends grpc.Client implements IZKPClient {
    ...
    public getCircuit(request: zkp_pb.GetCircuitRequest, callback: (error: grpc.ServiceError | null, response: zkp_pb.Circuit) => void): grpc.ClientUnaryCall;
    public getCircuit(request: zkp_pb.GetCircuitRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: zkp_pb.Circuit) => void): grpc.ClientUnaryCall;
    public getCircuit(request: zkp_pb.GetCircuitRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: zkp_pb.Circuit) => void): grpc.ClientUnaryCall;
