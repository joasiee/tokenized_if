...
import { ITitleEscrow } from "../../dist/typechain/ITitleEscrow";

export class ITitleEscrowFactory {
  static connect(address: string, signerOrProvider: Signer | Provider): ITitleEscrow {
