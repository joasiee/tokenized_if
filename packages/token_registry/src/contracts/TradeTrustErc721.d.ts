...
interface TradeTrustErc721Interface extends ethers.utils.Interface {
  functions: {
    ...
    "destroyToken(uint256)": FunctionFragment;
  ...
  events: {
    ...
    "TokenBurnt(uint256)": EventFragment;
...
export class TradeTrustErc721 extends Contract {
  ...
  filters: {
    ...
    TokenBurnt(tokenId: BigNumberish | null): EventFilter;
