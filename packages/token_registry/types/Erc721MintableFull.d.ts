...
interface Erc721MintableFullInterface extends ethers.utils.Interface {
  functions: {
...
export class Erc721MintableFull extends Contract {
  ...
  interface: Erc721MintableFullInterface;
