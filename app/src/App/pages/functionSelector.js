            ...
            <Aux>
                <Row>
                    <Col md={6} xl={4}>
                        ...
                        <Card class='rounded' tag="a" onClick={this.handleClickLSP} style={{ cursor: "pointer" }}>
                            <Card.Body>
                                <Card.Title><i className="feather icon-box text-c-green f-30 m-r-5" /><div class='font-weight-bold'>LSP - Logistic service provider</div></Card.Title>
                    ...
                    <Col md={6} xl={4}>
                        <Card class='rounded' tag="a" onClick={this.handleClickIMP} style={{ cursor: "pointer" }}>
                            <Card.Body>
                                <Card.Title><i className="feather icon-globe text-c-red f-30 m-r-5" /><div class='font-weight-bold'>Importer</div></Card.Title>
                    ...
                    <Col xl={4}>
                        <Card class='rounded' tag="a" onClick={this.handleClickFIN} style={{ cursor: "pointer" }}>
                            <Card.Body>
                                <Card.Title ><i className="feather icon-users text-c-blue f-30 m-r-5 " /><div class='font-weight-bold'>Financier</div></Card.Title>
