...
class NavItem extends Component {
    ...
    render() {
        ...
        if (this.props.item.external) {
            ...
            if (cookies.get("role") != this.props.item.role) {
                if (this.props.item.id != "profile") {
                    classes = [...classes, "disabled"];
                }
            }
            subContent = (
                <NavLink to={this.props.item.url} className={classes.join(' ')} exact={true} target={itemTarget}>
                    <NavIcon items={this.props.item} />
                    {itemTitle}
                    <NavBadge layout={this.props.layout} items={this.props.item} />
                </NavLink>
